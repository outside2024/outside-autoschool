  ...
  return (
    ...
    >
      ...
      >
            ...
            <div className="tabletHeaderLine">
              ...
              <div className="socialLngBlock">
                ...
                <div className="langBlock">
                  <Link className={locale === 'en' ? 'disabled' : ''} href={asPath} locale="en">
                    <p
                      className={`typoHeaderLink link linkText ${locale === 'en' ? 'active' : ''}`}
                    >
                      en
                    </p>
                  </Link>
                  ...
                  <Link className={locale === 'uk' ? 'disabled' : ''} href={asPath} locale="uk">
                    <p
                      className={`typoHeaderLink link linkText ${locale === 'uk' ? 'active' : ''}`}
                    >
                      ua
                    </p>
                  </Link>
        ...
        {showBranchesBlock && widowSize.width > 767 && (
          <div className="branchesBlock">
